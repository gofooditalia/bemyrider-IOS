...
public struct EmptyStateFormat {
    ...
    /// Title attributes
    public var titleAttributes: [NSAttributedString.Key: Any] = [.font: RobotoFont.medium(with: 24), .foregroundColor: UIColor.darkGray]
    
    /// Description attributes
    public var descriptionAttributes: [NSAttributedString.Key: Any] = [.font: RobotoFont.regular(with: 14), .foregroundColor: UIColor.darkGray]

    /// Button attributes
    public var buttonAttributes: [NSAttributedString.Key: Any] = [.font:  RobotoFont.medium(with: 14), .foregroundColor: UIColor.white]
